...
- **✅ 14 briefs NB2 nuevos escritos (2026-07-27)** en [[Briefs de Concept Art]] §11 (Haiku 4.5). Batch completo listo para correr en NB2 al ritmo que Boris quiera. Cubre: Driftmarket re-corrida, Wanderer's Goggles (item — inaugura carpeta `90-Raw/concept/props/`), Sunken Archive interior, First Wound clímax jugable, Grove of Cycles interior, oficina de Tobin, 3 torres de guardia (Aethelgard/Ignis Reach/Stillwood Watch), Rivermeet Council Chamber, Emberdeep vertical, Ascending Falls, Iven's Settlement, Mistbound Frontier interior. Todos con regla anti-texto + estilo maestro canónico.
  - **§11.3 Sunken Archive — YA CORRIDO Y QA'd:** v1 🔴 rechazada (se leyó como catacumba egipcia con momias). v2 ✅ ratificada (cuerpos-cristal fundidos a la piedra, Fragmento como foco dominante) — 🟡 nota menor: geometría salió gótica simétrica en vez de "alienígena que no cierra", no bloqueante. **Pendiente:** guardar `sunken-archive-interior-v2.png` en `90-Raw/concept/`.
  - **§11.5 Grove of Cycles — YA CORRIDO Y QA'd:** ✅ ratificada sin re-corrida. Túnel-catedral de árboles vivos, 4 figuras del Elder Circle confirmadas. 🟡 notas menores: Aether como wisp localizado en vez de difuso, luz más oliva que dorada, marcas en ramas superiores ambiguas (¿Warden script pedido o residuo de glitch de texto? no se resolvió, no bloqueante). **Pendiente:** guardar `grove-of-cycles-interior-v1.png` en `90-Raw/concept/`.
