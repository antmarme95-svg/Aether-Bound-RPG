...
| C6 | **Rework anatómico del cuerpo base del rig** (mandato del director 2026-07-07) | ⬜ | Tras Dagna in-engine: la anatomía está lejos de la lámina — el cuerpo base hereda gráficos del prototipo PRE-RESET que ya estaban corruptos; debió hacerse rework completo. Alcance: reconstruir el cuerpo (proporciones/volúmenes/cabeza-cara) DESDE las láminas de fenotipo (`90-Raw/concept/fenotipo-*.png`), no desde el prototipo; conservar la biomecánica ganada (hip-first, columna 2 seg, constraints). **Ventana RATIFICADA por el director (2026-07-07): entre el Gate 1 y la Fase 2, junto al pase de poses C4 (B15c/B15d)** — una sola cirugía anatómica, antes de que Fase 2 acumule contenido encima. Cláusula de escape: si en el playtest del Gate 1 los cuerpos impiden juzgar el FEEL, C6 se adelanta a dentro de PRD-007. El vestido final (materiales/cara/atlas) sigue en Fase 4 |
