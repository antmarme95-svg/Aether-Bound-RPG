...
Un C3 **bespoke por celda de jugador** ([[Matriz Raza x Rol]]); parejas
raza-a-raza elegidas caso por caso por máximo drama. Regla de escritura: las 9
traiciones son **reacciones distintas a la misma verdad**
...
> **La columna *Quiebre* es un resumen de una frase, no canon de escena.** La escena real de
> cada uno vive en su ficha (§sub-beat 5), y la mecánica compartida — dónde se detiene, quién
> es su mensajero, qué gatea cada final — en [[El Cráter — Matriz de Rutas]]. Si esta columna
> y la ficha divergen, **manda la ficha**.
...
| Humano Duelist | **Dagna** — Enana Vanguard (muralla) | Constancia, lealtad, raíces | La ley del clan pesa más que el nido que juró proteger; se le quiebra la voz mientras lo hace | *"The mountain doesn't forgive. And I am the mountain's."* |
