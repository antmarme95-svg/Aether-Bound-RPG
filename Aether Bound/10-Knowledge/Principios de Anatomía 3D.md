...
* *DOF (Degrees of Freedom):* incorporar DOF en la documentación técnica agnóstica (sin importar el motor) de los personajes. Notas de referencia Toño:
	...
	* El análisis cinemático del miembro inferior es muy similar al del brazo, pero está diseñado para la estabilidad y el soporte de peso en lugar de la manipulación. Al incluir la pelvis y la articulación sacroilíaca, el sistema gana una base móvil que conecta las extremidades con la columna vertebral.Si analizamos la pierna desde la pelvis hasta el tobillo (sin contar los dedos del pie), obtenemos un total de 9 DOF.El Complejo de la Pelvis (+3 DOF)A diferencia de la escápula, que se mueve libremente sobre los músculos de la espalda, la pelvis se mueve en bloque como una estructura rígida gracias a su conexión con la columna vertebral (articulación lumbosacra). Sus movimientos añaden tres grados de libertad globales:Anteversión y Retroversión (1 DOF): Inclinación hacia adelante (sacar glúteos) y hacia atrás (aplanar la espalda baja).Inclinación Lateral / Oblicuidad Pélvica (1 DOF): Elección o descenso de un lado de la cadera (ocurre de forma natural al dar un paso y dejar un pie en el aire).Rotación Pélvica (1 DOF): Giro de la pelvis hacia la izquierda o hacia la derecha sobre el eje vertical.Desglose Completo del Miembro Inferior (9 DOF)Sumando secuencialmente desde el tronco hasta el pie:Región ArticularArticulación EspecíficaTipo de Diartrosis / MecanismoDOFMovimientosPelvis (Global)Lumbosacra y Coxofemoral combinadasComplejo lumbopélvico3 DOFAnte/retroversión, inclinación lateral, rotación.CaderaCoxofemoralEnartrosis (Esferoidea)3 DOFFlexión/extensión, abducción/aducción, rotación interna/externa.RodillaFemorotibialTrocleartrosis / Condílea modificada*1 DOFFlexión y extensión.TobilloTalocrural (Tibiotarsiana)Trocleartrosis (Bisagra)1 DOFDorsiflexión (punta hacia arriba) y plantiflexión (punta hacia abajo).Pie (Subastragalina)SubastragalinaArtrodia (Plana)1 DOFInversión (planta hacia adentro) y eversión (planta hacia afuera).\(\text{Total\ con\ Pelvis}=3\text{\ (Pelvis)}+3\text{\ (Cadera)}+1\text{\ (Rodilla)}+1\text{\ (Tobillo)}+1\text{\ (Subastragalina)}=\mathbf{9}\text{\ DOF}\)*Nota biomecánica sobre la rodilla y el tobillo: Científicamente, la rodilla realiza una pequeña rotación axial automática cuando se flexiona, y el tobillo combina sus ejes en un movimiento llamado pronación/supinación. Sin embargo, para el cálculo estándar de cadenas cinemáticas, se simplifican a un solo eje funcional (1 DOF cada una) debido a las restricciones de los ligamentos.Diferencia Clave con el Brazo (9 DOF vs 10 DOF)Menor movilidad, más fuerza: El miembro inferior tiene un grado de libertad menos que el brazo porque la rodilla no tiene un equivalente a la pronosupinación del antebrazo (no podemos rotar la espinilla de forma aislada como lo hacemos con el radio y el cúbito).El pie compensa: El "segundo DOF" que le falta a la pierna en la espinilla se traslada a la articulación subastragalina del pie, lo que nos permite adaptarnos a terrenos irregulares sin perder el equilibrio.
	* Para calcular los grados de libertad (DOF) de la columna vertebral, debemos cambiar el enfoque. A diferencia de los brazos o las piernas, que funcionan como cadenas largas de pocos huesos, la columna es una estructura segmentada compuesta por 24 vértebras móviles alineadas en serie.Cada par de vértebras adyacentes forma una unidad funcional que aporta 3 DOF rotacionales muy sutiles. Al sumar estos pequeños movimientos a lo largo de todo el eje, la columna vertebral entera alcanza un total teórico de 72 DOF.La Unidad Funcional Intervertebral (+3 DOF)Cualquier segmento intervertebral (excepto las dos primeras vértebras cervicales) consta de una anfiartrosis (el disco intervertebral) y dos diartrosis artrodias (las articulaciones facetarias traseras). Juntas permiten:Flexión y Extensión (1 DOF): Inclinarse hacia adelante y hacia atrás.Inclinación Lateral (1 DOF): Doblarse hacia la izquierda o derecha (flexión lateral).Rotación Axial (1 DOF): Girar el tronco o el cuello sobre su propio eje vertical.Desglose por Regiones AnatómicasEl cálculo se divide según el número de vértebras móviles de cada zona del cuerpo:1. Columna Cervical (Cuello) = 21 DOFEs la región más móvil para permitir la orientación de la cabeza y los sentidos.Articulación Atlantooccipital (C0-C1): Condilartrosis modificada. Aporta 2 DOF (principalmente el gesto de decir "sí" con la cabeza e inclinación lateral).Articulación Atlantoaxial (C1-C2): Trocoide. Aporta 1 DOF (el gesto de decir "no" con la cabeza).Vértebras Cervicales Restantes (C2 a C7): Hay 5 segmentos intervertebrales típicos. Cada uno aporta 3 DOF.\(\text{Cálculo\ Cervical}=2+1+(5\times 3)=\mathbf{21}\text{\ DOF}\)2. Columna Torácica (Dorsal) = 36 DOFEs la región menos móvil debido a que las vértebras están ancladas a las costillas para proteger los pulmones y el corazón.Comprende desde la vértebra T1 hasta la T12, lo que genera exactamente 12 segmentos intervertebrales.\(\text{Cálculo\ Torácico}=12\times 3=\mathbf{36}\text{\ DOF}\)3. Columna Lumbar (Espalda Baja) = 15 DOFEstá diseñada principalmente para cargar el peso del torso y permitir grandes movimientos de flexión y extensión.Comprende desde la vértebra L1 hasta la L5, generando 5 segmentos intervertebrales móviles (incluyendo la unión con el hueso sacro).\(\text{Cálculo\ Lumbar}=5\times 3=\mathbf{15}\text{\ DOF}\)Resumen del Eje Raquídeo (72 DOF)Sumando las tres regiones móviles del eje central:\(\text{Total\ Columna}=21\text{\ (Cervical)}+36\text{\ (Torácica)}+15\text{\ (Lumbar)}=\mathbf{72}\text{\ DOF}\)(Nota: Los huesos del sacro y del cóccix están fusionados en el adulto, por lo que biomecánicamente aportan 0 DOF adicionales en condiciones normales).Importancia de la Distribución de MovimientoAunque 72 DOF suena a una movilidad extrema, la amplitud de movimiento (ROM) en grados angulares de cada vértebra individual es muy pequeña (apenas entre 2° y 15° según la zona).La ventaja de este diseño es que el movimiento total del torso es la suma de micro-movimientos sucesivos. Esto distribuye las cargas mecánicas a lo largo de toda la espalda y evita que la médula espinal que corre por su interior sufra dobleces abruptos o pellizcos que causarían daños neurológicos.
	* La mano humana cuenta tradicionalmente con 21 grados de libertad (DOF - Degrees of Freedom) distribuidos entre sus articulaciones mecánicas principales. Si se incluye la movilidad total de la muñeca, el sistema completo de la mano alcanza entre 23 y 24 grados de libertad en total.A continuación se detalla la distribución de los grados de libertad en cada sección de la mano:Grados de libertad en los dedos largos (Índice, Medio, Anular y Meñique)Cada uno de los cuatro dedos largos posee exactamente 4 grados de libertad:Articulación Metacarpofalángica (MCP): 2 DOF. Permite los movimientos de flexión/extensión (doblar el dedo) y de abducción/aducción (separar y juntar los dedos).Articulación Interfalángica Proximal (PIP): 1 DOF. Permite únicamente el movimiento de flexión/extensión.Articulación Interfalángica Distal (DIP): 1 DOF. Permite únicamente el movimiento de flexión/extensión.Total por dedo largo: 4 dedos × 4 DOF = 16 grados de libertad.Grados de libertad en el dedo pulgarEl pulgar posee una estructura única que le permite la oposición, sumando 5 grados de libertad según los modelos biomecánicos más aceptados:Articulación Trapeciometacarpiana o Carpometacarpiana (CMC): 2 DOF. Ubicada en la base, permite la flexión/extensión y la abducción/aducción necesarias para oponerse al resto de los dedos.Articulación Metacarpofalángica (MCP): 2 DOF. Permite flexión/extensión y movimientos limitados de rotación o lateralización.Articulación Interfalángica (IF): 1 DOF. Permite la flexión/extensión de la punta del pulgar.Total del pulgar: 5 grados de libertad.Resumen del sistema de la manoDedos largos: 16 DOF.Pulgar: 5 DOF.Total de la mano (dedos y palma): 21 grados de libertad.Muñeca (opcional): Añade comúnmente 2 a 3 grados de libertad adicionales (flexión/extensión, desviación radial/cubital y pronación/supinación del antebrazo).
	* En el desarrollo de videojuegos, los grados de libertad (DOF) de un humanoide representan un equilibrio constante entre realismo visual y costo de cómputo. Entre más DOF se analicen biomecánicamente, más natural es el movimiento, pero el juego se vuelve más pesado y difícil de programar.Los DOF afectan el análisis biomecánico y el desarrollo en cuatro áreas clave:1. Complejidad en la Cinemática Inversa (IK)La Cinemática Inversa calcula cómo deben rotar las articulaciones para que una mano o pie toque un punto exacto (por ejemplo, sostener una taza o pisar terreno irregular).Muchos DOF: Generan infinitas soluciones matemáticas para una misma pose. El sistema debe decidir cuál es la más natural, lo que eleva el uso de procesador (CPU).Pocos DOF: El cálculo es rápido, pero los miembros del personaje se mueven de forma rígida, robótica o cómica.2. Optimización del Motor de Animación (Rigging)Los desarrolladores nunca usan los 21 DOF reales de una mano humana debido al alto costo de rendimiento.Simplificación extrema: Las manos de personajes secundarios o de videojuegos móviles suelen reducirse a 1 o 2 DOF (la mano abre y cierra en bloque).Detalle en primeros planos: Los personajes principales en juegos AAA aumentan sus DOF en las manos para interacciones cinemáticas detalladas, desactivándolos cuando el personaje está lejos.3. Ragdolls y Motores de FísicaCuando un personaje muere o es golpeado, el motor de física (como Havok o PhysX) calcula sus movimientos en tiempo real.Cada DOF añade una restricción física que el motor debe procesar.Demasiados DOF libres en un esqueleto provocan errores de colisión (interpenetración de mallas) o el famoso "efecto espagueti", donde el cuerpo se deforma de manera no humana.