...
Lo que la traición te quita. Cada link tiene **setup + execution**, sirve en
combate *y* traversal; su pérdida es la orfandad mecánica de
[[Los 9 Pivotes]]. Nombres canónicos en inglés.

| Jugador + Pivote | Link | Funciona | Al perderlo |
|---|---|---|---|
| Elfo Duelist + Maren | **Skipping Stone** | Discos-boya flotantes; encadenas dashes/disparos rebotando entre ellos | Un arquero aéreo condenado al suelo |
...
Skyhook y Seismic Springboard son además atajos de escalada
([[Locomoción]]): co-op como sustituto de stat.
