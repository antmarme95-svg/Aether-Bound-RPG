...
mismo evento — ver **Los Tres Niveles de Conocimiento** abajo.

## Los Tres Niveles de Conocimiento

El evento no se recuerda igual en las 3 razas — la distancia generacional de
cada una con el cataclismo define qué tan sólida (o deformada) es su versión.

| Nivel | Raza | Quién recuerda directamente | Cómo se preserva | Textura |
|---|---|---|---|---|
| **1** | **Elfos** | ~5-10%, los más viejos (rondaban ya los 550+ años cuando ocurrió; techo de vida élfico ≈650-700, [[Las Tres Razas]]) | Biblioteca de The Stillspire + memoria viva de esos ancianos | Escolar pero también *personal* — un elfo joven puede literalmente preguntarle a un anciano vivo que lo vivió |
...
antiguos de The Stillspire (Nivel 1) — tratada ahí como leyenda, no como
hecho. Esto es lo que hace crítico y devastador el hallazgo de [[La
Rueda|Sunken Archive]] en el Acto 3: es la primera fuente que confirma,
sin ambigüedad, lo que hasta entonces era mito en sus tres versiones.

**La verdad (revelación central):** los God-Cores **no son núcleos de dioses
— son cadáveres calcificados de Wardens adultos** (la especie de [[Speck]]),
masacrados a mitad de **la Muda del Mundo** (the World-Molt): el gran reset
...
**El paisaje del giro:** The First Wound, el cráter donde la Muda se rompió —
un cementerio de God-Cores; zona final del juego ([[La Rueda]]).
