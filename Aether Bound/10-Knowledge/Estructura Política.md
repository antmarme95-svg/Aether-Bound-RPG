...
> ([[El Mundo y la Muda]]). **Nombres propios de instituciones en inglés**
> (decisión 2026-07-24: idioma primario del juego es inglés —
> [[Nomenclatura]] — el vault sigue en español, pero nombres propios de
> ahora en más van en inglés, incluyendo retraducción de lo ya escrito).

---

## Elfos (the Aether-Born) — The Stillwood

**Queen Ithessa**, 555 años — tenía apenas ~5 años durante el cataclismo. Gobierna
...
- **Academy of Sages** — tradición contemplativa: "observar sin
  intervenir". De aquí sale, por extensión, The Elder Circle. **Valen** es
  discípulo de esta academia — explica por qué sabe tanto pero actúa tan
  poco: es formación, no solo personalidad.
- **Royal Academy** — tradición aplicada al servicio de la Corona: "el
  ...
  - **Brazo encubierto de Royal Academy:** operativos negables al
...
- **Fuera de ambas Academias — Frontier High Command:** tercer track, no
...
distintas — son **productos de tres instituciones rivales** (Sages / Corona
visible / Corona encubierta) más una completamente ajena al juego político
(Frontier). Ver dinámicas completas en
...
### Great Forging Clan — Dos Centros de Poder

The Great Forging Clan **es el clan real** — no un gremio separado de la
...
**Sin dinastía estable.** En 550 años, al menos 6-8 dinastías/houses distintas
...
**Regent Edrick Ashcombe** — título actual: no es "King" en sentido
...
**El Trade Consortium** es el tercer centro de poder humano — no
político, práctico. El cuerpo comercial que mantiene viva la economía de
Aethelgard sin importar qué House ocupe el Regency esta década: las Houses
...
Clan** ("Vekka de Great Forging Clan" cumple la función sin serlo).

Los humanos sí tienen cultura de apellido/House — coherente con una sociedad
burocrática, papeleo, linajes en disputa, y golpes de estado (una guerra
civil necesita Houses: "House Ashcombe contra House X"). **Pero no todos lo
usan en la práctica:** el campesinado y la tropa rasa (Roen, Maren, Iven,
Bram por defecto) casi nunca usa apellido en el habla cotidiana aunque
exista en el papel — no es inconsistencia con las fichas ya escritas, es
...
- Vekka → Great Forging Clan → King Borran → **Ambassador Kadrun** (directo, sin subclán)
- Torgan → **su clan menor** → Great Forging Clan → King Borran → Ambassador Kadrun (el Juramento es al clan menor, no al Great Forging Clan que lo rechazó — [[El Cráter — Matriz de Rutas]] §2)
- Dagna → **subclán vasallo Deepstone** → Great Forging Clan → King Borran → Ambassador Kadrun
...
corregir, es pregunta abierta — pero el patrón de 550 años (6-8 Houses
...
|---|---|---|
| Élfico | Ambassador Cyrion | Designado por Queen Ithessa, larga permanencia |
