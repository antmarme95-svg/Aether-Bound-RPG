...
**Roen en el ascenso — su tramo, y es el único del grupo que hace algo:** carga a Speck y no la suelta hasta arriba. **Excepción declarada — la ruta Bram:** ahí Speck no pasa por los brazos de Roen en ningún momento del ascenso. Bram la levanta en la sala del Fragmento y **se la devuelve al jugador** al rehusar, y el jugador la carga el Archive entero hasta la superficie ([[Pivotes/Bram-Ficha-Expandida-v1|Bram]] §Sub-beat 2b: La ruptura — la sala del Fragmento). En esa ruta el beat de Roen no es cargarla: es ir último, entre Speck y Bram, todo el ascenso — la misma función, hecha con el cuerpo en otro lugar. (**La ruta Nyael no es excepción:** Nyael no está en el ascenso, Speck sí, y Roen la carga como en las otras siete; lo que cambia es que la pierden recién en el corredor de salida.) Nadie se lo pide y nadie se lo agradece. Es la forma que Roen tiene de sostener un grupo que ya no existe: seguir haciendo el turno cuando el puesto ya cayó. Cuando el Pivote se acerca a ayudar en un tramo difícil —y se acerca, porque sigue siendo el mejor en lo suyo— Roen no lo rechaza. Deja que ayude. **Le duele más aceptarlo que negárselo**, y lo acepta igual, porque negárselo sería teatro y el grupo todavía tiene que subir.

Cuando el Pivote es **Bram**, el ascenso es lo contrario —el link no murió y el Pivote sube del lado del grupo— y **Roen es el primero en entender lo que Bram acaba de hacer**, tres segundos antes que Valen ([[Pivotes/Bram-Ficha-Expandida-v1|Bram]] §Sub-beat 2b: La ruptura — la sala del Fragmento). Ahí también es donde Speck sale de sus brazos por última vez en esa ruta: Bram la carga de él y se la devuelve al jugador.
...
**Traición:** Sereth expresa su decisión con afecto sorprendente. Roen reconoce que Sereth ama profundamente mientras actúa contra ello — la traición más íntima del elenco, vista desde adentro ([[Los 9 Pivotes]] §Superlativo Consolidado). *"I see you. I still won't let you do this."* Es, de las ocho traiciones que no son la de Dagna, la que más cerca llega de romperlo — no porque Sereth calcule como el Triune Council que mató a los niños del asentamiento purgado, sino porque **ama** como el Triune Council nunca amó, y aun así llega al mismo lugar. Roen se queda un momento largo sin decir nada más. No es el quiebre de Dagna — es su sombra.
