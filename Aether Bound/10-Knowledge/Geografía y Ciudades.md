...
- **Decisiones del jugador sobre el Pivote en el tramo hacia el cráter**: dos o tres puntos donde el jugador puede elegir entre alcanzar y detener al mensajero de la cadena del Pivote activo **antes de que complete la entrega** (la ruta que abre F1: más corta, elegíaca, con luto — **no cruel** — [[Los 5 Finales]] §F1) o dejar que el Pivote llegue al **borde** del cráter con Speck y esperar ahí — nunca al centro — para que **el jugador** le pregunte qué quiere (más largo, más doloroso, único que permite F4). **En ninguna de las dos Speck llega al cráter sola:** el Pivote la carga hasta el borde en todos los casos, y se detiene ahí. Estas decisiones no se anuncian con UI — se juegan con el botón de Bond (rehusarlo es una decisión).
