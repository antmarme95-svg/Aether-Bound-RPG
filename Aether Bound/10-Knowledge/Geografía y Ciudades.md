...
> Mapa completo de ubicaciones mencionadas, ciudades por reino, y beats por acto.
...
```
                    THE WILDS (cubo central)
                    [EL NIDO - Speck location]
                    [THE FIRST WOUND - final]
                            ↑
         ┌──────────────────┼──────────────────┐
         │                  │                  │
      CINDER ASCENT    GLOOMVAULT       RIVER ROAD
      (montaña)     (bosque profundo)  (río navegable)
         │                  │                  │
    ┌────↓────┐        ┌────↓────┐       ┌────↓────┐
...
## Los Tres Reinos: Ciudades y Asentamientos
...
- **Iven's Settlement** (nombre sin confirmar) — asentamiento rural moribundo
  ...
  - Muere lentamente por corrupción de Aether
...
### 2. IGNIS REACH (Reino Enano — Este)
...
**Asentamientos Secundarios:**
- **Ignis Outposts** (múltiples fortalezas menores)
  - Puestos de minería / defensa territorial
  - Control de arterias (Cinder Ascent)
  - Suministran Emberdeep
...
- **Clima:** Árido, ventoso, desolado
- **Conexión:** Donde la civilización se desmorona en frontera

### SUNKEN ARCHIVE (Bóveda Subterránea — Central/Bajo)
...
## Los Desfiladeros de Zephyr (Tutorial)
...
**Versión Enana (Ignis Reach):**
- Bajada por caverna volcánica
- Encuentro con geotérmicos/lava
- Introducción a recursos subterráneos

**Versión Elfa (Stillwood):**
- Ascenso por bosque denso
...
### ACTO 2: La Rueda Completa (All 3 Kingdoms)
**Duración:** ~90-120 min

**Estructura:** Tres "actos secundarios", uno por reino (orden elegible)

#### Sub-Acto 2A: Rivermeet (Aethelgard)
**Locaciones:**
...
#### Sub-Acto 2B: Emberdeep (Ignis Reach)
**Locaciones:**
1. **Entrada a Ignis Reach**
   - Cinder Ascent (montaña empinada, co-op anclaje)
   - Ember Workshops secundarios
...
3. **Geothermal Vents**
   - Boss final enano: constructor corrupto
...
#### Sub-Acto 2C: Stillwood (Stillwood)
**Locaciones:**
1. **Entrada a Stillwood**
   - Gloomvault (bosque profundo, co-op luz)
   - Sky Watchtowers (frontera)

2. **The Stillspire interior**
...
3. **Crown of Stillwood**
   ...
   - Boss final élfico: ave corrupta maestra
...
### ACTO 2 Interludios: The Driftmarket + Momentos de Speck
...
- Desde Emberdeep: ves corrupción en Stillwood
- Desde Stillwood: ves corrupción en Rivermeet
...
| **Torgan** | Enano | Mensajero **del clan menor de Torgan** — no del Great Forging Clan, que lo rechazó — confirmando un juramento **de 55 años**, no jurando uno nuevo | **Darro** — enano hijo de forja, aprendiz rechazado del Clan; Tobin sabe que reconocería el idioma ritual |
| **Dagna** | Enana | Renovación de votos del subclán vasallo **Deepstone**, con la orden implícita de **entregar una pieza en custodia al clan superior** — vocabulario de vasallaje militar, sin una sola palabra de forja | **Darro** — enano con familia atada al Clan, único del grupo que "hablaría con un mensajero enano sin traducción" |
...
### Fast Travel (Pendiente)
- **Barcazas del Driftmarket:** viaje entre reinos (mecánica diegética)
- **Túneles enanos:** viajes subterráneos Emberdeep ↔ otros
...
## Ciudades/Personajes por Región (Quick Reference)
...
### Rivermeet
- **Maren's Negotiation:** 2 años atrás, acuerdo de paz
- **Political Heart:** Donde Standing importa más
- **Iven's Burden:** Pueblo cercano muere lentamente
...
### The Stillspire
- **Valen's Observation:** Donde ve ciclos desde altura
- **Sereth's Library:** Donde calcula en soledad
- **Lyris's Sky:** Donde ella patrulla (nunca baja hasta El Nido)
- **Nyael's Circles:** Donde ejecutores entrenan
...
- **Traición Trigger:** Donde el Pivote actúa (saliendo)
- **Lore Lock:** Punto de no retorno narrativamente
