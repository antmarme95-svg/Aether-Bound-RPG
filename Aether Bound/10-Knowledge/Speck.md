...
semi-corrompidas, ya no protegen sino atacan. Destruyes el nido (tu misión).
Encuentras la crisálida con Speck dentro — debería destruirla, pero no lo haces.
...
antinatural. Mejor lo llevamos."

**Capa 2 — Lo que VES TÚ (tu poder innato):**
Flashes ocasionales donde ves la verdad bajo el disfraz:
- Los teals se ven como **seams aether, no como pelaje**
- La pata delantera es **cristal visible, no deformidad**
...
- Se comporta *intencionalmente* menos "zorro" delante de Darro (camina raro,
  mira de formas no-naturales) — es irónica sobre su propio disfraz
...
**Especificación nueva RATIFICADA 2026-07-23:**
- Forma base: NO salamandra/axolotl — es **Warden cristalino + runas + translúcido**
- Estructura: cristal visible bajo piel translúcida, no "biológica pura"
- Runas geométricas grabadas (símbolos Warden, dormidas en E1, activadas en E3)
- Seams aether son *grietas donde el poder fluye*, no decoración
...
shapeshifteada (zorro) en progreso (NB Pro). Briefs: [[Briefs de Concept Art]]
§5-redireccionado (en actualización 2026-07-23).

**Pendiente:** Briefs E2/E3 reescritos, evaluación de E1 concept art, generación
de forma shapeshifteada.
