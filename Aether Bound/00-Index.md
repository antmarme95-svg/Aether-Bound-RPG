...
- [[Principios de Anatomía 3D]] — minado de "Anatomy for 3D Artists": cintura escapular como bloque separado, sistema de mitades sucesivas para nudillos, pelo = masa completa primero + variación anti-paralelismo. Insumo para `SHOULDER_X`/manos/pelo, nada aplicado aún en código. **⚠️ Revisado 2026-08-21** tras el barrido completo del libro: **5 correcciones en línea** (la caja torácica es CAJA y no cilindro — causa raíz del torso-bola · la fracción 2/3–1/3 no tiene fuente y omite el abdomen · media regla de mandíbula · el libro SÍ tiene sección de oreja · los capítulos *Advanced* estaban descartados y son la fuente principal de animación). Y dos límites de la fuente: **no trae medidas horizontales** y su **conteo de cabezas no es estable** — el 7.5 del humano es decisión del director, no del libro. Sigue en `propuesto`.
- [[Grados de Libertad del Rig]] — **RATIFICADA (2026-08-21).** Fuente única de DOF, agnóstica de motor. Inventario medido: **32 DOF**; miembro inferior completo 9/9, superior 4/10. Recorte aprobado: **+12 DOF** (escápula ×2, pronosupinación ×2, muñeca ×2) y ni uno más — el conteo de DOF es diagnóstico, no meta. Trae las 3 leyes de **acoplamiento** que el rig no tiene (ritmo escapulohumeral cifrado, asimetría lumbar/torácico, acumulación de torsión) y el fix barato del pivote de cabeza.
...
- **Los 3 fijos — una sola fuente viva cada uno:** [[Roen-Ficha-Expandida-v1]] · [[Valen-Ficha-Expandida-v1]] · [[Darro-Ficha-Expandida-v1]]. **Los tres migrados a la ruptura de dos tiempos (Roen 2026-08-12, Valen y Darro 2026-08-13):** su reacción al quiebre vive en **§Escena 1 — la sala del Fragmento (sub-beat 2b)**, citando por ruta las líneas ya escritas en las 9 fichas de Pivote; la escena del cráter quedó recortada a reacción contenida y a los 5 finales. Detalle en [[2026-08]] §2026-08-13.
