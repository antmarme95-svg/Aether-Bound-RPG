...
- [[Pivotes/Dagna-Ficha-Expandida-v1]] — ficha viva del Pivote del slice (bio Deepstone, 5 años con el jugador, arco 3 actos, 5 finales, visual v2). Los tiers del Springboard y la Primera Cuña viven en [[Los 9 Links del Pivote]]. La ficha v0 quedó archivada en `90-Raw/Dagna-ficha-v0-ARCHIVADA.md` — contradecía a la expandida en origen, apellido y reclutamiento.
